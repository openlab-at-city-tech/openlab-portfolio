<div class="wrap nosubsub import-page">
	...
	<p><strong><?php _e( 'Step 1: Choose and upload your Portfolio Archive file (.zip).', 'openlab-portfolio' ); ?></strong></p>
	...
	<form method="post" enctype="multipart/form-data" action="<?php echo esc_url( $this->get_url(1) ); ?>">
		...
		<label class="screen-reader-text" for="importzip"><?php _e( 'Import zip file', 'openlab-portfolio' ); ?></label>
